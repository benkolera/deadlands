...
hinderancesToDesc :: Hinderances -> (Text, [Text])
hinderancesToDesc = \case
  OathChurch ->
  ...
  Poverty ->
    ( "Lives simply and donates her money to sgare the love and will of God"
    , []
    )
  Heroic ->
...
blessingsToDesc :: Blessings -> (Text, [Text])
blessingsToDesc = \case
  ...
  Confession ->
    ( "Makes lying to the preacher very difficult."
    , [ "Lying to a preacher is kind of like lying to your mother. Most folks don’t do it too well, and it usually isn’t a whole lot of fun even when they do."
      , "With this miracle, it’s even tougher to pull the wool over a blessed’s eyes. The blessed chooses a character when she invokes the miracle. If she’s successful, the target finds it incredibly difficult to lie to her."
